...
STATIC const mp_map_elem_t modules_globals_table[] = {
    ...
    { MP_ROM_QSTR(MP_QSTR_ultrasonic),      (mp_obj_t)(&modules_ultrasonic_type) },
    { MP_ROM_QSTR(MP_QSTR_onewire),         (mp_obj_t)(&modules_onewire_type) },
#if CONFIG_MAIXPY_WS2812_ENABLE
    { MP_ROM_QSTR(MP_QSTR_ws2812),          (mp_obj_t)(&modules_ws2812_type) },
#endif
#if CONFIG_MAIXPY_HTPA_ENABLE
    { MP_ROM_QSTR(MP_QSTR_htpa),            (mp_obj_t)(&modules_htpa_type) },
#endif
#if CONFIG_MAIXPY_AMG88XX_ENABLE
    { MP_ROM_QSTR(MP_QSTR_amg88xx),         (mp_obj_t)(&modules_amg88xx_type) },
#endif
};
